...
if ( ! class_exists( 'Company_Elite_Demo' ) ) {
	 ...
	 * @version 2.0.2
	 */
	class Company_Elite_Demo {

		/**
		 * Singleton instance of Company_Elite_Demo.
		 *
		 * @var Company_Elite_Demo $instance Company_Elite_Demo instance.
		 */
		...
		/**
		 * Main Company_Elite_Demo instance.
		 *
		 * @since 1.0.0
		 *
		...
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Company_Elite_Demo ) ) {
				self::$instance = new Company_Elite_Demo();
