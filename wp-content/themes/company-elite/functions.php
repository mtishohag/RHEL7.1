...
function company_elite_scripts() {
	...
	wp_enqueue_style( 'company-elite-style', get_stylesheet_uri(), array(), '2.0.2' );
	...
	wp_enqueue_script( 'company-elite-custom', get_template_directory_uri() . '/js/custom' . $min . '.js', array( 'jquery' ), '2.0.2', true );
...
function company_elite_admin_scripts( $hook ) {
	...
	if ( 'widgets.php' === $hook ) {
	    wp_enqueue_media();
		wp_enqueue_style( 'company-elite-widgets', get_template_directory_uri() . '/css/widgets' . $min . '.css', array(), '2.0.2' );
		wp_enqueue_script( 'company-elite-widgets', get_template_directory_uri() . '/js/widgets' . $min . '.js', array( 'jquery' ), '2.0.2', true );
	}
